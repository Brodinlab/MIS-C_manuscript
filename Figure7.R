...
# Figure 7F
ELISA <- read.csv("https://ki.box.com/shared/static/0s0l67ij5uap9k8of5jwhgmk0th934dr.csv", stringsAsFactors = FALSE, row.names = 1)
...
#[1] ComplexHeatmap_2.0.0        UpSetR_1.4.0                VennDiagram_1.6.20          futile.logger_1.4.3        
#[5] org.Hs.eg.db_3.8.2          AnnotationDbi_1.46.1        clusterProfiler_3.12.0      tibble_3.0.2               
